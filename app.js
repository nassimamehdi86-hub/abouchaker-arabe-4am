    ...
    "sections": [
      {
        ...
        "instructions": "أتمم المخطط الآتي وفق ما درست.",
        "type": "fill",
        "items": [
          {
            "before": "التوابع<br>ـــــــــــــــــــ<br>الخانة العلوية (فوق «التوابع» مباشرة): .....<br>الخانة اليسرى: .....&nbsp;&nbsp;|&nbsp;&nbsp;الخانة اليمنى: .....<br>الخانة السفلى: التوكيد<br>ـــــــــــــــــــ<br>اكتب الكلمات الثلاث الناقصة بالترتيب (العلوية، ثم اليسرى، ثم اليمنى) مفصولة بفواصل",
            "after": "",
            "answer": "النعت، العطف، البدل"
          }
        ]
      },
      {
        ...
        "items": [
          {
            "before": "استخرج البدل والمُبدل منه ونوع البدل الثلاثة مما سبق، واكتب إجاباتك مرتبة",
            "after": "",
            "answer": "جمال بدل من الوالد وهو بدل كل من كل (مطابق)، نصفه بدل من الكتاب وهو بدل بعض من كل، أفكاره وأسلوبه بدل من الكتاب وهو بدل اشتمال"
          }
        ]
      },
      {
