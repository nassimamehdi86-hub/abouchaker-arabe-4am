...
const LESSON_EXERCISES = {
  ...
  'badal': {
    ...
    "sections": [
      {
        "title": "التمرين 11: أتمم المخطط الآتي وفق ما درست",
        "instructions": "أتمم المخطط الآتي وفق ما درست. (التوابع: الخانة العلوية، الخانة اليسرى، الخانة اليمنى، والخانة السفلى وهي «التوكيد»)",
        "type": "fill",
        "items": [
          {
            "before": "الخانة العلوية في مخطط التوابع (فوق «التوابع» مباشرة) هي",
            "after": ".",
            "answer": "النعت"
          },
          {
            "before": "الخانة اليسرى في مخطط التوابع هي",
            "after": ".",
            "answer": "العطف"
          },
          {
            "before": "الخانة اليمنى في مخطط التوابع هي",
            "after": ".",
            "answer": "البدل"
          }
        ]
      ...
      {
        "title": "التمرين 12: استخرج البدل والمُبدل منه ونوع البدل مما يلي",
        "instructions": "قال الوالدُ جمالٌ لابنه عادل: أراك قرأتَ الكتابَ نِصفَه، فهل أعجبك؟ قال عادل: نعم أعجبني الكتابُ أفكارُه، وأسلوبُه.",
        "type": "fill",
        "items": [
          {
            "before": "في «قال الوالدُ جمالٌ لابنه عادل»، المُبدَل منه هو",
            "after": ".",
            "answer": "الوالد"
          },
          {
            "before": "في «قال الوالدُ جمالٌ لابنه عادل»، البدل هو",
            "after": ".",
            "answer": "جمال"
          },
          {
            "before": "نوع البدل في «الوالدُ جمالٌ» هو",
            "after": ".",
            "answer": "بدل كل من كل (مطابق)"
          },
          {
            "before": "في «أراك قرأتَ الكتابَ نِصفَه»، المُبدَل منه هو",
            "after": ".",
            "answer": "الكتاب"
          },
          {
            "before": "في «أراك قرأتَ الكتابَ نِصفَه»، البدل هو",
            "after": ".",
            "answer": "نصفه"
          },
          {
            "before": "نوع البدل في «الكتابَ نِصفَه» هو",
            "after": ".",
            "answer": "بدل بعض من كل"
          },
          {
            "before": "في «أعجبني الكتابُ أفكارُه، وأسلوبُه»، المُبدَل منه هو",
            "after": ".",
            "answer": "الكتاب"
          },
          {
            "before": "في «أعجبني الكتابُ أفكارُه، وأسلوبُه»، البدل هو",
            "after": ".",
            "answer": "أفكاره وأسلوبه"
          },
          {
            "before": "نوع البدل في «الكتابُ أفكارُه» هو",
            "after": ".",
            "answer": "بدل اشتمال"
          }
        ]
      ...
      {
        "title": "التمرين 13: ضع في كل مكان من الأمكنة الخالية بدلًا مطابقًا مناسبًا واضبطه بالشكل",
        "instructions": "ضع في كل مكان من الأمكنة الخالية بدلًا مطابقًا مناسبًا واضبطه بالشكل.",
        "type": "fill",
        "items": [
          {
            "before": "أ/ كان أمير المؤمنين",
            "after": "مثالًا للعدل.",
            "answer": "عُمَرُ"
          },
          {
            "before": "ب/ اشتهر خليفة النبي",
            "after": "برقة القلب.",
            "answer": "أبو بكرٍ"
          },
          {
            "before": "ج/ يسر الحاكِمَ",
            "after": "أن ترقى أُمَّتُه.",
            "answer": "خالدًا"
          },
          {
            "before": "د/ سافر أخي",
      ...
      {
        "title": "التمرين 14: ضع في كل مكان من الأمكنة الخالية بدل اشتمال مناسبًا واضبطه بالشكل",
        "instructions": "ضع في كل مكان من الأمكنة الخالية بدل اشتمال مناسبًا واضبطه بالشكل.",
        "type": "fill",
        "items": [
          {
            "before": "أ/ راقتني حديقة دارك",
            "after": ".",
            "answer": "منظرُها"
          },
          {
            "before": "ب/ أعجبني الأستاذ",
            "after": ".",
            "answer": "شرحُه"
          },
          {
            "before": "ج/ وثقتُ بصديقك",
            "after": ".",
            "answer": "كلامِه"
          },
          {
            "before": "د/ فرحت بهذا الطالب",
            "after": ".",
            "answer": "علاماتِه"
          },
          {
            "before": "هـ/ أحببت محمداً",
            "after": ".",
            "answer": "سَمتَه"
          },
          {
            "before": "و/ رضيت خالداً",
            "after": ".",
            "answer": "حَكَمَا"
          }
        ]
      ...
      {
        "title": "التمرين 15: أعرب ما يلي",
        "instructions": "أعرب ما يلي إعرابًا تامًا.",
        "type": "irab",
        "items": [
          {
            "word": "1) سطع القمر نورُه",
            "answer": "سطعَ: فعل ماض مبني على الفتح. القمرُ: فاعل مرفوع وعلامة رفعه الضمة الظاهرة على آخره. نورُهُ: نور بدل اشتمال من القمر مرفوع وعلامة رفعه الضمة الظاهرة على آخره، وهو مضاف، والهاء ضمير متصل مبني على الضم في محل جر مضاف إليه."
          },
          {
            "word": "2) كان أبو الطيب المتنبي شاعرًا حكيمًا",
            "answer": "كان: فعل ماض ناقص مبني على الفتح. أبو: اسم كان مرفوع وعلامة رفعه الواو لأنه من الأسماء الخمسة، وهو مضاف. الطيّبِ: مضاف إليه مجرور وعلامة جره الكسرة الظاهرة على آخره. المتنبّي: بدل مطابق مرفوع وعلامة رفعه الضمة المقدرة على الياء منع من ظهورها الثقل. شاعرًا: خبر كان منصوب وعلامة نصبه الفتحة الظاهرة على آخره. حكيمًا: نعت منصوب وعلامة نصبه الفتحة الظاهرة على آخره."
          },
          {
            "word": "3) سرّني الخادمُ أمانتُه",
            "answer": "سرّني: فعل ماض مبني على الفتح، والياء للوقاية، والنون ضمير متصل مبني على السكون في محل نصب مفعول به. الخادمُ: فاعل مرفوع وعلامة رفعه الضمة الظاهرة على آخره. أمانتُه: بدل اشتمال من الخادم مرفوع وعلامة رفعه الضمة الظاهرة على آخره، وهو مضاف، والهاء ضمير متصل مبني على الضم في محل جر مضاف إليه."
          },
          {
            "word": "4) بنيتُ الدارَ أساسَها",
            "answer": "بنيتُ: فعل ماض مبني على السكون لاتصاله بتاء المتكلم، والتاء ضمير متصل مبني على الضم في محل رفع فاعل. الدارَ: مفعول به منصوب وعلامة نصبه الفتحة الظاهرة على آخره. أساسَها: بدل بعض من كل منصوب وعلامة نصبه الفتحة الظاهرة على آخره، وهو مضاف، و«ها» ضمير متصل مبني على السكون في محل جر مضاف إليه."
          },
          {
            "word": "5) ذلك الكتابُ مفيدٌ",
            "answer": "ذلك: اسم إشارة مبني على الفتح في محل رفع مبتدأ (أو: ذا اسم إشارة مبني على السكون في محل رفع مبتدأ، واللام للبعد مبني على الكسر لا محل له من الإعراب، والكاف حرف خطاب مبني على الفتح لا محل له من الإعراب). الكتابُ: بدل مطابق مرفوع وعلامة رفعه الضمة الظاهرة على آخره. مفيدٌ: خبر مرفوع وعلامة رفعه الضمة الظاهرة على آخره."
          }
        ]
      }
    ]
