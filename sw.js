...
const CACHE_NAME = 'abou-chaker-lâabbadi-v3'; /* غيّر الرقم هنا مستقبلاً فقط إذا أردت تفريغ ذاكرة كل الأجهزة قسرًا — تم رفعه هنا عمدًا لإجبار كل الأجهزة على تفريغ الذاكرة القديمة (v2) التي كانت تعترض طلبات Firestore خطأً */
const CORE_ASSETS = [
