...
const CACHE_NAME = 'abou-chaker-lâabbadi-v7'; /* غيّر الرقم هنا مستقبلاً فقط إذا أردت تفريغ ذاكرة كل الأجهزة قسرًا — رُفع الآن لتفعيل زر التسجيل الصوتي 🎤 في تمارين الدرس فورًا لكل الأجهزة */
const CORE_ASSETS = [
