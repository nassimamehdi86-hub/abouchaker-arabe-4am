...
const CACHE_NAME = 'abou-chaker-lâabbadi-v4'; /* غيّر الرقم هنا مستقبلاً فقط إذا أردت تفريغ ذاكرة كل الأجهزة قسرًا — رُفع الآن لضمان وصول إصلاح أيقونة القفل في قائمة الدروس لكل الأجهزة فورًا */
const CORE_ASSETS = [
